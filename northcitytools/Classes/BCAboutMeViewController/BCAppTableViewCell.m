...
- (void)initSubview{
    ...
    _appIconImageView = [[UIImageView alloc]initWithFrame:CGRectMake(kAUTOWIDTH(20), kAUTOHEIGHT(20), kAUTOWIDTH(60), kAUTOHEIGHT(60))];
    //    iconImage.image = [UIImage imageNamed:@"iconcheng"];
    [self.contentView addSubview:_appIconImageView];
    _appIconImageView.layer.cornerRadius = kAUTOHEIGHT(8);
    ...
    _appIconLayer.cornerRadius = kAUTOHEIGHT(8);
    ...
    _appNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_appIconImageView.frame) + kAUTOWIDTH(20),kAUTOHEIGHT(25),kAUTOWIDTH(150),kAUTOHEIGHT(25))];
    ...
    _appDetailNameLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMaxX(_appIconImageView.frame) + kAUTOWIDTH(20),CGRectGetMaxY(_appNameLabel.frame) + kAUTOHEIGHT(5),kAUTOWIDTH(150),kAUTOHEIGHT(18))];
    ...
    _getButton.frame = CGRectMake(ScreenWidth - kAUTOWIDTH(98), kAUTOHEIGHT(35.f), kAUTOWIDTH(70), kAUTOHEIGHT(30));
    ...
    _getButton.layer.cornerRadius = kAUTOHEIGHT(15);
    NSLog(@"===%@===",[self getCurrentAppUrlScheme]);
    
    _appVersionLabel = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetMinX(_getButton.frame),CGRectGetMaxY(_getButton.frame),kAUTOWIDTH(70),kAUTOHEIGHT(15))];
